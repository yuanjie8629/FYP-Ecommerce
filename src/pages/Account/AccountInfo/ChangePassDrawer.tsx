...
interface ChangePassDrawerProps extends DrawerProps {}

const ChangePassDrawer = (props: ChangePassDrawerProps) => {
  ...
  const handleChangePassDrawer = (values) => {
      ...
      <Space direction='vertical' size={30} className='full-width'>
        ...
        <Space direction='vertical' size={20} className='full-width'>
          ...
          <Form
            ...
            form={changePassForm}
            layout='vertical'
            onFinish={handleChangePassDrawer}
          >
